...
> เวอร์ชันล่าสุด: **v3.16.0** · ไม่รู้ว่าโปรเจกต์ใช้รุ่นไหน → `node buaflow/bin/buaflow.js lock` (ถ้ามี `.buaflow/lock.json`)
...
|---|---|---|
| **v2.3.4 – v3.12.1** | [ทางลัด: ไป v3.16.0 ในรอบเดียว](#fast-path) | ~5 นาที + ขั้นที่ต้องลงมือถ้าเข้าเงื่อนไข |
| **v3.15.0** | [v3.15.0 → v3.16.0](#v3150--v3160-minor--คัดลอกไฟล์ทับ-จบ) ข้างล่างนี้ | ~1 นาที |
