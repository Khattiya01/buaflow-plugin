...
kit ทั้งชุดมากับ plugin — ไม่ต้อง clone อะไร · `/buaflow:start` ดูสถานะโปรเจกต์เอง แล้วเริ่ม Phase 0 หรือทำต่อจากที่ค้าง · อัปเกรดโปรเจกต์ที่ติดตั้งรุ่นเก่าคือ `/buaflow:upgrade` ·
